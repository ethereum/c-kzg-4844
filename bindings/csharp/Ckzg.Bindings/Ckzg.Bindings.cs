...
public static partial class Ckzg
{
    ...
    [DllImport("ckzg", EntryPoint = "compute_cells", CallingConvention = CallingConvention.Cdecl)]
    private static extern unsafe KzgResult ComputeCells(byte* cells, byte* blob, IntPtr ts);
